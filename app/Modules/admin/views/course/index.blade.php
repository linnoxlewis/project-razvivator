                    ...
                    <table class="table">
                        ...
                        @foreach($model as $course)
                            <tr>
                                ...
                                <td><a href="/admin/course/view/{{$course->id}}"> {{$course->name}}</a></td>
                                <td>@if (!empty($course->tasks)) {{count($course->tasks)}} @else 0 @endif</td>
                                <td>{{App\Modules\admin\helpers\StatusHelper::getStatus($course->status)}}</td>
                                <td>
                                    <a href="/admin/course/change?id={{$course->id}}" class="settings" title="Settings"
                                       data-toggle="tooltip"><i class="material-icons">&#xE8B8;</i></a>
                                    <a href="/admin/course/delete/{{$course->id}}" class="delete" title="Delete"
                                       data-toggle="tooltip"><i class="material-icons">&#xE5C9;</i></a>
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="course" method="GET" class=" mr-auto">
